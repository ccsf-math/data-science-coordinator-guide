...
1. Add an issue to the project for each item from the course materials. The issue should live in the appropriate repository. (e.g. Create the `Lecture 01: Introduction` issue in the `materials-fa25-staff` repository.) For each issue:
